...
<div><h3><?php echo vmText::_ ('COM_VIRTUEMART_CART_STEP_1') ?></h3></div>
<div class="table-step">      
    ...
    width="100%">
        <tr>
            <th align="left" ><span><?php echo vmText::_ ('COM_VIRTUEMART_USER_FORM_BILLTO_LBL'); ?></span></th>
            <th align="left" ><span><?php echo vmText::_ ('COM_VIRTUEMART_USER_FORM_SHIPTO_LBL'); ?></span></th>
        </tr>
        
        <tr>
			<?php // Output Bill To Address Rechnung ?>
            <td align="left" >
			<?php
            ...
            <?php // Output Bill To Address shipto ?>
            <td>
				<?php
        ...
        <tr>
			...
			<?php //Button für Rech-adresse bearbeiten?>
            <td>
				<?php
            ...
            <?php //Button für Lieferadresse ändern ?>
            <td>
				<?php 
