...
?>  <div class="addtocart-bar-neu">
	...
	if ($product->show_notify) { ?>
        <a class="btn btn-primary w-100" href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=productdetails&layout=notify&virtuemart_product_id=' . $product->virtuemart_product_id); ?>" ><?php echo vmText::_ ('COM_VIRTUEMART_CART_NOTIFY') ?></a><?php
	} else {
		...
		<div class="fd-qtygroup">
            <div class="quantity-box-neu">
				<input type="<?php echo $editable ?>" class="quantity-input-neu" name="quantity[]"
			...
			<?php if ($product->orderable) { ?>
				<div class="quantity-controls-neu">
					<div class="quantity-controls-neu quantity-plus "/><i class="fa fa-angle-up"></i></div>
					<div class="quantity-controls-neu quantity-minus"/><i class="fa fa-angle-down"></i></div>
				</div>
			<?php } ?>
		</div>
			...
			if(!empty($addtoCartButton)){
				?><div class="addtocart-button-neu">
