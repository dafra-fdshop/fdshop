...
<?php   }
    ...
    <form id="com-form-login" action="<?php echo JUri::root(true).'/'.$url; ?>" method="post" name="com-login" >
        ...
        <div>
        <h4><?php echo vmText::_('COM_VIRTUEMART_ORDER_CONNECT_FORM'); ?></h4>
        </div>
        <?php } else { ?>
        <div>
        <h4><?php echo vmText::_('COM_VIRTUEMART_ORDER_CONNECT_FORM'); ?></h4>
		...
		<div class="mod-login__userdata userdata">
			<fieldset class="userdata">
				...
				<div class="mod-login__remember form-group">
					...
					<div class="form-check" id="com-form-login-remember">
				...
				<div class="mod-login__submit form-group">
					<input type="submit" name="Submit" class="btn btn-primary" value="<?php echo vmText::_('COM_VIRTUEMART_LOGIN') ?>" />			
				</div>			
			</fieldset>
		</div>
