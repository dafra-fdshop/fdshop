...
Fixtures represent schema `0.0.24` and the current CouponService, packaging-unit model, configurable-bundle foundation, and category-aware filter configuration:
