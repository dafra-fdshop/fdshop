...
Fixtures represent schema `0.0.25` and the current CouponService, packaging-unit model, configurable-bundle foundation, category-aware filter configuration, and product-media configuration:
